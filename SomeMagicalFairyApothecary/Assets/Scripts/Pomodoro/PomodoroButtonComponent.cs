...
/// Pomodoro timer. It is display-only: it raises <see cref="Clicked"/> and never
/// shows or hides any panel itself (the UIManager owns visibility).
/// </summary>
[RequireComponent(typeof(UIDocument))]
public class PomodoroButtonComponent : MonoBehaviour
{
    private const string ButtonName = "pomodoro-button";
